...
import ru.real.backend.impl.service.apartment.CeilingDecorationService;
...
@RequestMapping(value = "/api/v1/ceiling-decorations", produces = {MediaType.APPLICATION_JSON_VALUE})
public class CeilingDecorationController implements DictionaryResource {
    private final CeilingDecorationService service;
